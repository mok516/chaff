...
```{r malechaff-fig, out.width="30%", fig.cap = "Male Chaffinches have a recognisable red plumage, Picture from Wikipedia, Common Chaffinch, https://en.wikipedia.org/wiki/Common_chaffinch"}
knitr::include_graphics("../chaff/chaffmale.jpg")
```
<!-- insert next pic -->

```{r chafffem-fig, out.width="30%", fig.cap= "Female Chaffinches have a brown plumage unlike the males, Picture from Wikipedia, Common Chaffinch, https://en.wikipedia.org/wiki/Common_chaffinch"}
